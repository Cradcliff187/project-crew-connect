...
-- Then create project_documents table if it doesn't exist
...
-- Finally, create convert_estimate_to_project function with correct column mapping
CREATE FUNCTION convert_estimate_to_project(p_estimate_id TEXT)
RETURNS TEXT AS $$
DECLARE
  v_estimate RECORD;
