...
-- Create convert_estimate_to_project function (FINAL VERSION WITH CORRECT DOCUMENT COLUMNS)
...
BEGIN
  ...
  -- Link documents if estimate_documents table has data - WITH CORRECT COLUMNS
