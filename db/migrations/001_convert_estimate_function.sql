...
BEGIN
  ...
  -- Transfer documents directly attached to the estimate
  FOR v_document IN
...
COMMENT ON FUNCTION convert_estimate_to_project(TEXT) IS 'Converts an estimate to a project with proper status transitions, document transfer, date preservation, and duplicate item prevention';
