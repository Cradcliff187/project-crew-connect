...
import { documentCardAnimations } from '@/lib/animations';
...
const DocumentPreviewCard: React.FC<DocumentPreviewCardProps> = ({
  ...
  const handleNavigateToEntity = (e: React.MouseEvent) => {
    e.stopPropagation();
    ...
    switch (document.entity_type.toUpperCase()) {
      case 'PROJECT':
        url = `/projects/${document.entity_id}`;
        break;
      case 'WORK_ORDER':
        url = `/work-orders/${document.entity_id}`;
        break;
      case 'VENDOR':
        url = `/vendors/${document.entity_id}`;
        break;
      case 'CUSTOMER':
        url = `/customers/${document.entity_id}`;
        break;
      case 'ESTIMATE':
        url = `/estimates/${document.entity_id}`;
        break;
      default:
        return;
    }
  ...
  return (
    <Card 
      className={cn(
        ...
        isSelected && documentCardAnimations.selected,
