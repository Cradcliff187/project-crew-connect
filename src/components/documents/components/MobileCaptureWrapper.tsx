      ...
      <Dialog open={showMobileCapture} onOpenChange={setShowMobileCapture}>
        <DialogContent className="p-0 max-w-[95vw] sm:max-w-md h-[80vh] flex flex-col">
                    ...
                    <Card className="w-[80%] bg-white/90">
                      <CardContent className="pt-4">
                        <p className="text-center text-sm">
                          Position the document in good lighting and ensure all text is clearly visible
                        </p>
                      </CardContent>
                    </Card>
                  </div>
          ...
          <div className="p-4 flex justify-between items-center flex-shrink-0">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-flip-horizontal"><path d="m3 7 5 5-5 5V7"/><path d="m21 7-5 5 5 5V7"/><path d="M12 20v2"/><path d="M12 14v2"/><path d="M12 8v2"/><path d="M12 2v2"/></svg>
            </Button>
