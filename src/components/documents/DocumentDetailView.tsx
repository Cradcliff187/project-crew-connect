...
import { Download, Calendar, FileText, Tag, LinkIcon, Trash2 } from 'lucide-react';
...
const DocumentDetailView: React.FC<DocumentDetailViewProps> = ({
  ...
  const showMetadata = Boolean(document.tags?.length || document.category || document.notes);
      ...
      <DialogContent className={isMobile ? 'w-[95vw] max-w-full' : 'sm:max-w-[900px] max-h-[90vh]'}>
        ...
        <div className="flex flex-col md:flex-row gap-6 overflow-hidden">
          ...
          <div className="flex-1 min-h-[300px] md:max-h-[500px] overflow-hidden flex flex-col">
            <DocumentViewer document={document} open={true} onOpenChange={() => {}} />
          </div>
          ...
          <div className="w-full md:w-80 flex flex-col">
            ...
            <div className="mt-4 pt-4 space-y-2 border-t">
              <Button onClick={handleDownload} className="w-full bg-[#0485ea] hover:bg-[#0375d1]">
