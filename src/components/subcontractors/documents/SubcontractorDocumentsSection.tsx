...
interface SubcontractorDocumentsSectionProps {
  subcontractorId: string;
  subcontractorName?: string;
}

export default function SubcontractorDocumentsSection({
  subcontractorId,
  subcontractorName = 'Subcontractor',
}: SubcontractorDocumentsSectionProps) {
  ...
  const fetchDocuments = useCallback(async () => {
    ...
    try {
      ...
      console.error('Error fetching subcontractor documents:', err);
      toast({
        title: 'Error',
        description: 'Failed to load subcontractor documents.',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
  ...
  }, [subcontractorId, fetchDocuments]);
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-medium">Subcontractor Documents</h3>
      ...
      {viewType === 'grid' ? (
        <DocumentsGrid
          documents={documents}
          isLoading={isLoading}
          emptyMessage="No subcontractor documents found"
      ...
      <Dialog open={uploadOpen} onOpenChange={setUploadOpen}>
        <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col overflow-hidden">
          <DialogHeader>
            <DialogTitle>Upload Subcontractor Document</DialogTitle>
            <DialogDescription>
              Upload documents related to {subcontractorName} such as contracts, certificates, or
