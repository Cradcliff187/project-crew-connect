  ...
  const handleSubmit = async (data: ProjectFormValues) => {
    ...
    try {
      ...
      if (!customerId && data.newCustomer.customerName) {
        // Note: We don't provide customerid as it will be auto-generated by a database trigger
      ...
      // Note: We don't provide projectid as it will be auto-generated by a database trigger
