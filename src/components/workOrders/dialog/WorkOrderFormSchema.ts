...
export const workOrderFormSchema = z.object({
  ...
  // Calendar Integration - removed manual toggle, now automatic
  // calendar_sync_enabled: z.boolean().default(false), // No longer needed
  // calendar_event_id: z.string().optional(), // Not in types yet
