    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <WorkOrderProgressCard workOrder={workOrder} onProgressUpdate={handleRefresh} />
            </CardContent>
          </Card>
        ...
        <TabsContent value="time">
          <WorkOrderTimelogs workOrderId={workOrder.work_order_id} onTimeLogAdded={handleRefresh} />
        </TabsContent>

        <TabsContent value="expenses">
          <WorkOrderExpenses workOrderId={workOrder.work_order_id} onExpenseAdded={handleRefresh} />
        </TabsContent>
      </Tabs>
    </div>
  );
