...
export type Database = {
  public: {
    Tables: {
        ...
        Relationships: [
          {
            ...
            columns: ["calendar_id"]
            isOneToOne: false
            referencedRelation: "organization_calendar"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "calendar_access_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
      ...
      calendar_settings: {
        Row: {
          ...
          notify_external_attendees: boolean | null
          updated_at: string | null
        }
        Insert: {
          calendar_id: string
      ...
      push_notification_channels: {
        ...
        Relationships: [
          {
            foreignKeyName: "push_notification_channels_calendar_id_fkey"
            columns: ["calendar_id"]
            isOneToOne: false
            referencedRelation: "sync_cursors"
    ...
    Functions: {
      ...
      get_all_calendar_settings: {
        Args: Record<PropertyKey, never>
        Returns: Json
      }
      get_calendar_costs_by_project: {
      ...
      update_calendar_settings: {
        Args: {
          ...
          p_notify_external_attendees: boolean
        }
        Returns: boolean
      }
      ...
      update_sync_cursor: {
        Args: { p_calendar_id: string; p_next_sync_token: string }
        Returns: boolean
      }
      upsert_assignment: {
        Args: {
