            ...
            <div className="space-y-6">
                ...
                <CardContent>
                  {reportConfig.selectedFields.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-64 border border-dashed rounded-md">
                      <p className="text-muted-foreground mb-4">No fields selected</p>
                      <p className="text-sm text-muted-foreground">Add fields to preview your report</p>
                    </div>
                  ) : (
                    <Button className="w-full" onClick={handleGeneratePreview}>
                      Generate Preview
                    </Button>
                  )}
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Export and share your report</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm">Schedule Report</Label>
                ...
                <CardFooter>
                  <Button className="w-full bg-[#0485ea] hover:bg-[#0370c9]">
                    Save Report
                  </Button>
                </CardFooter>
              </Card>
